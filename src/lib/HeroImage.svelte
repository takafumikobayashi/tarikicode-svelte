		...
		<div class="swiper-wrapper">
			...
			<div class="swiper-slide">
				<LayoutGrid>
					<Cell align="middle" span={6}>
						<div class="mdc-typography--headline5 hero-title">
							{AppConfig.heroimage[0].descpiption}
						</div>
					...
					<Cell align="middle" span={6}>
						<div
							class="hero"
							style="background-image: url({AppConfig.heroimage[0].image});"
						/>
					</Cell>
				</LayoutGrid>
			</div>
			<div class="swiper-slide">
				<LayoutGrid>
					<Cell align="middle" span={6}>
						<div class="mdc-typography--headline5 hero-title">
							{AppConfig.heroimage[1].descpiption}
						</div>
						<div class="mdc-typography--body1">
					...
					<Cell align="middle" span={6}>
						<div
							class="hero"
							style="background-image: url({AppConfig.heroimage[1].image});"
						/>
					</Cell>
				</LayoutGrid>
			</div>
			<div class="swiper-slide">
				<LayoutGrid>
					<Cell align="middle" span={6}>
						<div class="mdc-typography--headline5 hero-title">
							{AppConfig.heroimage[2].descpiption}
						</div>
						<div class="mdc-typography--body1">
					...
					<Cell align="middle" span={6}>
						<div
							class="hero"
							style="background-image: url({AppConfig.heroimage[2].image});"
						/>
					</Cell>
				</LayoutGrid>
			</div>
