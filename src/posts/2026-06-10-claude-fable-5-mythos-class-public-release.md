...
> **【追記：2026-06-20】** 本記事の公開後、2026年6月12日にAnthropicはFable 5・Mythos 5へのアクセスを**一時停止**しました。GitHub Copilotでも同日からFable 5が全面停止されています。そのため、以下で「呼び出せる」と記した状態では**現在は利用できません**（復旧時期は未定）。経緯と現状は記事末尾の「[追記] 提供状況の更新」にまとめています。本文のスペック・ベンチマーク・設計の解説は、一般公開時点（6月9日）の記録としてお読みください。
...
### 7. [追記] 提供状況の更新（2026-06-20時点）

一般公開からわずか3日後、状況は大きく動きました。**2026年6月12日、AnthropicはFable 5とMythos 5へのアクセスを一時停止しました。** 公式の更新告知は次のように述べています。
...
>
> （Claude Fable 5・Claude Mythos 5へのアクセスを停止します。お客様にご迷惑をおかけすることをお詫びするとともに、可能な限り早期の復旧に努めています。）

告知では**停止の具体的な理由や復旧の時期は明示されていません**。「できるだけ早く復旧させる」とのみ記されています。

GitHub Copilotも同日、これに追随しました。Copilotの変更履歴には「Anthropicの発表を受け、本日付でClaude Fable 5へのアクセスをすべてのGitHub Copilot環境で停止した」と追記され、**Copilot全体でFable 5が使えなくなった**ことが告知されています。なお、Claude Opus 4.8・Sonnet 4.6・Haiku 4.5など他のClaudeモデルは影響を受けず、引き続き利用可能です。

| 項目 | 現状（2026-06-20時点） |
| ---- | ---------------------- |
| Claude API / Claude Code | Fable 5・Mythos 5ともにアクセス停止中 |
| GitHub Copilot | Fable 5を全環境で停止（他のClaudeモデルは継続） |
| 停止の理由 | 公式告知では非開示 |
| 復旧見込み | 未定（「可能な限り早期に」とのみ） |

本文で解説したスペック・ベンチマーク・「refusal＋フォールバック」の安全設計は、一般公開時点（6月9日）の事実として有効ですが、**現時点でFable 5を実際に呼び出すことはできません**。利用を検討していた場合は、Anthropicおよびご利用チャネルの最新告知で復旧状況を確認してください。
